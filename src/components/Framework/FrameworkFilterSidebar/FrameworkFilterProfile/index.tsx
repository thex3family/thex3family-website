...
import { useFrameworkFilterProfile } from "./useFrameworkFilterProfile"
  ...
  return (
    <Flex direction="column" gap={4} p={{ base: 4, sm: 0 }}>
      <Box
        ...
        color="secondary"
      >
        <Translation id="page-better-life-framework:page-better-life-framework-filters-description" />
      </Box>
