  ...
  const featureDropdownItems: Array<DropdownOption> = [
    {
      ...
      value: t("page-find-framework-open-source"),
      filterKey: "open_source",
      category: "security",
      icon: OpenSourceWalletIcon,
    },
    {
      label: t("page-find-framework-self-custody"),
      value: t("page-find-framework-self-custody"),
    ...
    },
    {
      ...
      value: t("page-find-framework-hardware-framework-support"),
    ...
    },
    {
      ...
      value: t("page-find-framework-walletconnect"),
    ...
    },
    {
      ...
      value: t("page-find-framework-rpc-importing"),
    ...
    },
    {
      ...
      value: t("page-find-framework-nft-support"),
    ...
    },
    {
      ...
      value: t("page-find-framework-connect-to-dapps"),
    ...
    },
    {
      ...
      value: t("page-find-framework-staking"),
      filterKey: "staking",
      category: "feature",
      icon: StakingIcon,
    },
    {
      ...
      value: t("page-find-framework-swaps"),
      filterKey: "swaps",
      category: "feature",
      icon: SwapIcon,
    },
    {
      ...
      value: t("page-find-framework-layer-2"),
      filterKey: "layer_2",
      category: "feature",
      icon: Layer2Icon,
    },
    {
      ...
      value: t("page-find-framework-gas-fee-customization"),
    ...
    },
    {
      ...
      value: t("page-find-framework-ens-support"),
      filterKey: "ens_support",
      category: "feature",
      icon: ENSSupportIcon,
    },
    {
      label: t("page-find-framework-token-importing"),
      value: t("page-find-framework-token-importing"),
    ...
    },
    {
      ...
      value: t("page-find-framework-fee-optimization"),
    ...
    },
    {
      ...
      value: t("page-find-framework-buy-crypto"),
    ...
    },
    {
      ...
      value: t("page-find-framework-sell-for-fiat"),
    ...
    },
    {
      ...
      value: t("page-find-framework-multisig"),
      filterKey: "multisig",
    ...
    },
    {
      ...
      value: t("page-find-framework-social-recovery"),
