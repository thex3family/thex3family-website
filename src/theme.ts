...
const lightColors = {
  ...
  cardBoxShadow: "4px 4px 0px 0px #71ccae",
  homeBoxMint: mint,
...
const darkColors = {
  ...
  infoLink: primaryLight800,
  infoLinkHover: primaryLight900,
  cardBoxShadow: "4px 4px 0px 0px #f4d866",
