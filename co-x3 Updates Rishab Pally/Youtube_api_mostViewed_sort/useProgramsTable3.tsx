...
export const useFrameworkTable= {({
  ...
  useEffect(() => {
    const fetchViewCounts = async () => {
      const viewCountsData = await videoCounts();
  ...
  const filteredFrameworks= useMemo(()=> {
    ...
    let frameworksToProcess = filteredFrameworks;

    const updateSortOrder= (newSortOrder: typeof sortOrder) =>{
  ...
  return{
    filteredFrameworks: frameworksToProcess,
    updateSortOrder,
  };
}